...
class Ui_Accueil(object):
    def setupUi(self, Accueil):
        ...
        self.BU = QtWidgets.QLineEdit(self.centralwidget)
        self.BU.setGeometry(QtCore.QRect(620, 200, 191, 31))
        ...
        self.type_menu.setGeometry(QtCore.QRect(220, 200, 191, 31))
        ...
        self.equipe = QtWidgets.QLineEdit(self.centralwidget)
        self.equipe.setGeometry(QtCore.QRect(620, 260, 191, 31))
        self.equipe.setText("")
    ...
    def retranslateUi(self, Accueil):
        ...
        self.type_menu.setItemText(0, _translate("Accueil", "Informatique"))
        self.type_menu.setItemText(1, _translate("Accueil", "Téléphonie"))
        self.type_menu.setItemText(2, _translate("Accueil", "Cuisine"))
        self.type_menu.setItemText(3, _translate("Accueil", "Meuble"))
