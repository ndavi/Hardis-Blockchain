...
class Ui_Accueil(object):
    def setupUi(self, Accueil):
        ...
        self.menuEnregistrer_du_mat_riel = QtWidgets.QMenu(self.menubar)
        self.menuEnregistrer_du_mat_riel.setObjectName("menuEnregistrer_du_mat_riel")
        self.menuD_placer_du_mat_riel = QtWidgets.QMenu(self.menubar)
        self.menuD_placer_du_mat_riel.setObjectName("menuD_placer_du_mat_riel")
        ...
        self.menubar.addAction(self.menuEnregistrer_du_mat_riel.menuAction())
        self.menubar.addAction(self.menuD_placer_du_mat_riel.menuAction())
...
" matériel enregistré"))
        self.menuHardis_Mat_riel.setTitle(_translate("Accueil", "Hardis Matériel"))
        self.menuEnregistrer_du_mat_riel.setTitle(_translate("Accueil", "Enregistrer matériel"))
        self.menuD_placer_du_mat_riel.setTitle(_translate("Accueil", "Déplacement matériel"))
