...
"responsable"))
        ...
        self.type_txt_3.setItemText(2, _translate("Accueil", "Pole Assurance"))
        self.type_txt_3.setItemText(3, _translate("Accueil", "Salesforce"))
        self.type_txt_3.setItemText(4, _translate("Accueil", "Indifférent"))
        self.type_txt_3.setItemText(5, _translate("Accueil", "Autre"))
