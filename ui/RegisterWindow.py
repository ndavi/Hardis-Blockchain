...
class RegisterWindow(QMainWindow, mainwindowUI.Ui_MainWindow):
    ...
    def register_equipment(self):
        ...
        self.api.registerEquipment(type_english, brand, serial_number, purchase_date, business_unit, team, owner)
